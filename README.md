...
- mmr checker 생성
pyinstaller -w -F --icon=icon.ico --add-data="logo.png;." --add-data="icon.ico;." --add-data="rule_info.png;." DBD_MMR_Calculator.py
py -m PyInstaller -w -F --icon=icon.ico --add-data="logo.png;." --add-data="icon.ico;." DBD_MMR_Calculator.py
